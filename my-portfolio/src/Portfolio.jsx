...
function Portfolio() {
  ...
  const sectionIds = isMobile
    ? ['hero', 'about', 'experience', 'projects', 'certifications']
    : ['about', 'experience', 'projects', 'certifications']

  // Get the active section from scroll spy using the new container ID
  const activeSection = useScrollSpy(sectionIds, 'scroll-container')
  ...
  return (
    <div className='portfolio-wrapper' style={backgroundStyle}>
      ...
      <div className='content-column' id='scroll-container'>
        ...
        <div className='section-wrapper' ref={certificationsRef} id='certifications'>
          <div className='content-container'>
